...
Create `frontend/.env.local` with the Flask server URL:
...
development setup. Keep trailing slashes consistent with the Flask route (for
example, use `/api/products/` for the products collection).
